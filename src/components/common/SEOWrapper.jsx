...
const SEOWrapper = ({
  ...
  const canonicalUrl = getCanonicalUrl(
    "https://Multimodal-Sign-Language-Recognition.github.io/MSLR-2026",
    path,
  );
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="MSLR, sign language recognition, CVPR 2026, IEEE, computer vision, workshop, multimodal, Hawaii, sign language"
        />
        ...
        />
        <meta name="apple-mobile-web-app-title" content="MSLR 2026" />
