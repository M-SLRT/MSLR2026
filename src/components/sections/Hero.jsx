...
import cvpr_stamp from "../../assets/images/CVPR_date.png";
import signLanguageHands from "../../assets/images/signLanguageLetterBg.png";
import DenverSkyline from "../../assets/images/CVPR_Denver_2026.jpg";

const Hero = () => {
    const title = "2nd Multimodal Sign Language Recognition Workshop";
    const subtitle = "June 3, 2026, Room 210/212";
